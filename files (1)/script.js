...
const employeesData = [
    { id: 1, name: "Sarah Johnson", role: "Senior Sales Rep", callsPerDay: 42, conversions: 18, revenue: 24500, rating: 4.8 },
    { id: 2, name: "Michael Chen", role: "Sales Representative", callsPerDay: 38, conversions: 15, revenue: 19800, rating: 4.6 },
    { id: 3, name: "Emily Rodriguez", role: "Account Executive", callsPerDay: 45, conversions: 21, revenue: 28600, rating: 4.9 },
    { id: 4, name: "David Park", role: "Sales Representative", callsPerDay: 35, conversions: 12, revenue: 16200, rating: 4.3 },
    { id: 5, name: "Jennifer Martinez", role: "Senior Sales Rep", callsPerDay: 40, conversions: 17, revenue: 22400, rating: 4.7 },
    { id: 6, name: "Robert Taylor", role: "Sales Representative", callsPerDay: 33, conversions: 11, revenue: 14800, rating: 4.2 },
    { id: 7, name: "Lisa Anderson", role: "Account Executive", callsPerDay: 41, conversions: 19, revenue: 25900, rating: 4.8 },
    { id: 8, name: "James Wilson", role: "Sales Representative", callsPerDay: 36, conversions: 13, revenue: 17500, rating: 4.4 }
];
...
const weeklyCallsData = {
    ...
    calls: [285, 312, 298, 324, 315, 145, 98],
    conversions: [42, 48, 45, 51, 49, 22, 15]
};

const weeklyRevenueData = {
    labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
    revenue: [32500, 38200, 35800, 41200, 39500, 18400, 12200]
};
